...
% run the simulation
[t, u] = TimeSeries(f, g, tmax, dt, y0, 'heteroclinic');
...
[power_x,power_y,power_Q,power_exact_Q] = PowerSpectrum(f, g, pst(end), Delta, Num, freq, Mtrial, y0*rand, X, Y, Q, lambda_chosen, 'heteroclinic');
